...
- `git clone https://github.com/UniversalPropositions/UP_Chinese-GSD.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Chinese-GSD>/ --input_up=<up_path_to_UP_Chinese-GSD>/ --output=<path_to_UD+UP_Chinese-GSD>/`
